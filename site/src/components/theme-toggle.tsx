...
export function ThemeToggle() {
  ...
  /* Hydration never patches attributes, so aria-label would keep its
     server-rendered value; flipping this after mount forces one client render
     with the real state. */
  ...
  // Plain "d" toggles the theme, skipped while typing.
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <Moon className="size-4.5 not-dark:hidden" aria-hidden="true" />
    </Button>
  )
}
